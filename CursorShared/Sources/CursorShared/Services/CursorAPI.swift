...
public class CursorAPI {
    public static let shared = CursorAPI()
    ...
    public func fetchUsage(token: String) async throws -> ModelUsageResponse {
    ...
    public func fetchUsageLimit(token: String, teamId: Int? = nil) async throws -> UsageLimitResponse {
...
public enum CursorAPIError: Error {
...
public struct UsageLimitResponse: Codable {
    public let hardLimit: Double?
    public let hardLimitPerUser: Double?
    public let noUsageBasedAllowed: Bool?
}
